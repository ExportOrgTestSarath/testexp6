...
import { EtabApiConstants } from './etab.api-constants';
...
public baseService = inject(BaseService);
	  ...
	  getProtoTypingData(): Observable<any> {
	      const subject:Observable<EtabBase> = new Observable(observer => {
	        const data =  require('base/assets/sample-data/etab.json');
	        observer.next(data as EtabBase);
	      });
	      return subject;
	  }
	    ...
	    let data: any = {};
	    const subject: Observable<EtabBase> = new Observable(observer => {
	      const response = require('base/assets/sample-data/etab.json');
	      response.map((o: any) => {
    ...
    create(...args: any):Observable<any>{
        const serviceOpts = EtabApiConstants.create;
        const params= args[0];
    ...
    update(...args: any):Observable<any>{
        const serviceOpts = EtabApiConstants.update;
        const params= args[0];
    ...
    getDatatableData(...args: any):Observable<any>{
        const serviceOpts = EtabApiConstants.getDatatableData;
        const params= args[0];
    ...
    getById(...args: any):Observable<any>{
        const serviceOpts = EtabApiConstants.getById;
        const params= args[0];
    ...
    delete(...args: any):Observable<any>{
        const serviceOpts = EtabApiConstants.delete;
        const params= args[0];
    ...
    autoSuggestService(...args: any):Observable<any>{
        const serviceOpts = EtabApiConstants.autoSuggestService;
        const params= args[0];
