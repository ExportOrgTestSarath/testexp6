...
import com.vanenburgdemo.exapp.base.model.constants.EtabConstantBase;
...
@Component
public abstract class EtabPerimeterBaseImpl<T extends EtabBase> implements IPerimeterManager<T>, EtabConstantBase {
	
	private Logger LOGGER = LoggerFactory.getLogger(EtabPerimeterBaseImpl.class);
